    ...
    <view class="cu-bar tabbar bg-white">
      <view class="action" @click="selectNavClick(0)">
        <view class="cuIcon-cu-image">
          ...
          />
          <view class="cu-tag badge" v-if="tabBarList[0].badge">99</view>
        </view>
      ...
      <view class="action" @click="selectNavClick(1)">
        <view class="cuIcon-cu-image">
          ...
          />
          <view class="cu-tag badge" v-if="tabBarList[1].badge">99</view>
        </view>
      ...
      <view class="action" @click="selectNavClick(2)">
        <view class="cuIcon-cu-image">
          ...
          />
          <view class="cu-tag badge" v-if="tabBarList[2].badge">99</view>
        </view>
